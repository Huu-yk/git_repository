                        ...
                        <div class="widget-content">
                            <ul class="contacts-info-list">
                                <li>
                                    ...
                                    <div class="info-item">
                                        230 GuangZhou University City Outer Ring Road, Guangzhou, P.R. China, 510006
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <span class="info-item">
													<a href="huyaokun730@gmail.com">huyaokun730@gmail.com</a>
												</span>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    Copyright &copy; 2017  <a href="">huyaokun</a> &nbsp;| &nbsp;All Rights Reserved
                </div>
            </div>
        </div>
    </div>
